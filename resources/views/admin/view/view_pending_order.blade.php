    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><a href="javascript:avoid(0)">View Pending Order</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
        ...
        <div class="col-sm-12">
            <div class="panel b-primary bt-md">
                <div class="panel-content">
                    <div class="row">
                        <div class="col-xs-6"><h4>Pending Order Info</h4></div>
                        <div class="col-xs-6 text-right">
                            <a href="{{route('pending-order')}}" class="btn btn-primary" style="margin-right:4px;">All Pending Order</a>
                            <a href="{{route('print-order')}}" class="btn btn-primary" data-toggle="tooltip" title="Print Info"><i class="fa fa-print" aria-hidden="true"></i></a>
                        </div>
                    </div><hr>
                    <div class="p-info">
                            ...
                            <div class="panel panel-accordion">
                                <div class="row">
                                    <div class="col-xs-8" style="padding: 0px !important;padding-left: 15px !important;
                                        ...
                                        <div class="panel-header bg-scale-0" style="background: white !important;">
                                            <p class="panel-title"><span class="color-primary text-bold" style="display:inline;">Product Status:</span> Pending</p>
                                        </div>
                                    </div>
