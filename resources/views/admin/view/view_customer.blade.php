    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><a href="javascript:avoid(0)">View Customer Info</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
                ...
                <div class="panel-content">
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            <a href="{{route('all-customer')}}" class="btn btn-primary" style="margin-right:4px;">All Customer</a>
                            <form method="GET" style="display:inline;">
                            @csrf
                            <a href="{{route('print-customer', $customers->id)}}" target="_blank" class="btn btn-primary pdf" data-toggle="tooltip" title="Print Info"><i class="fa fa-print" aria-hidden="true"></i></a>
                            </form>
                        </div>
                    </div><hr>
                    <div class="p-info">
