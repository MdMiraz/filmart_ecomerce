    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><a href="javascript:avoid(0)">View Daily Report</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
        ...
        <div class="col-sm-12">
            <div class="panel b-primary bt-md">
                <div class="panel-content">
                    <div class="row">
                        <div class="col-xs-6"><h4>Daily Report Info</h4></div>
                        <div class="col-xs-6 text-right">
                            <a href="{{route('daily-report')}}" class="btn btn-primary" style="margin-right:4px;">All Daily Report</a>
                            <a href="" class="btn btn-primary" data-toggle="tooltip" title="Print Info"><i class="fa fa-print" aria-hidden="true"></i></a>
                        </div>
                    </div>
                    <h6 class="mb-xlg text-center"><b>Order Date <span class="color-primary text-bold">12/6/2020</span></b></h6><hr>
                    <div class="p-info">
