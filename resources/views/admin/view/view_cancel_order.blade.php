    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><a href="javascript:avoid(0)">View Cancel Order</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
        ...
        <div class="col-sm-12">
            <div class="panel b-primary bt-md">
                <div class="panel-content">
                    <div class="row">
                        <div class="col-xs-6"><h4>Cancel Order Info</h4></div>
                        <div class="col-xs-6 text-right">
                            <a href="{{route('cancel-order')}}" class="btn btn-primary" style="margin-right:4px;">All Cancel Order</a>
                            ...
                            <div class="panel panel-accordion">
                                <div class="row">
                                    <div class="col-xs-8" style="padding: 0px !important;padding-left: 15px !important;
                                        ...
                                        <div class="panel-header bg-scale-0" style="background: white !important;">
                                            <p class="panel-title"><span class="color-primary text-bold" style="display:inline;">Product Status:</span> Cancel</p>
                                        </div>
                                    </div>
