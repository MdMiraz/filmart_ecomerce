    ...
    <div class="col-md-12">
        <div class="panel b-primary bt-md">
            <div class="panel-content">
                <div class="row">
                    <div class="col-xs-6"><h4>Edit Sub Category Form</h4></div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form method="post" action="{{route('update-sub-category')}}" id="inline-validation" class="form-horizontal">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Sub Category Name" name="sub_category_name" value="{{$sub_category['sub_category_name']}}" required>
