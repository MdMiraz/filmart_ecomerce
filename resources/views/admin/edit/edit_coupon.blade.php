    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><a href="javascript:avoid(0)">Edit Coupon</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
    ...
    <div class="col-md-12">
        <div class="panel b-primary bt-md">
            <div class="panel-content">
                <div class="row">
                    <div class="col-xs-6"><h4>Edit Coupon Form</h4></div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form method="post" action="{{route('update-coupon')}}" id="inline-validation" class="form-horizontal">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" data-validation="required" value="{{$coupons['price_off']}}" name="price_off" class="form-control" placeholder="Price Off" required>
                                    @error('price_off')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" data-validation="required" value="{{$coupons['occassion']}}" name="occassion" class="form-control" placeholder="Occation" required>
                                    @error('occassion')
                                    <strong class="text-danger">{{$message}}</strong>
                                    @enderror
                                </div>
